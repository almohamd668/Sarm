import image from "../../assets/bout-logo2.png";
      ...
      <div className="px-[30px] md:px-[150px] md:pe-[32px] relative mx-auto flex h-full w-full items-start justify-center">
        <div className="flex flex-col gap-2  md:gap-6 items-start lg:flex-row order-2">
          ...
          <div className="flex flex-col w-full lg:w-1/2 text-start items-center justify-start mt-[40px]">
            ...
            <div className=" md:mt-4 flex gap-5 justify-start items-center">
              <a
                target="_blank"
                rel="noopener noreferrer"
                href="https://t.me/+905354669000"
                className="!p-0 w-[50px] md:w-[80px] h-[50px] md:h-[80px]  flex items-center
                justify-center backdrop-blur-[1px] rounded-lg bg-gradient-to-r hover:scale-110
                 from-[#0a2532]/60 to-[#0a2532]/70 btn2"
              >
              ...
              <a
                ...
                className="!p-0 w-[50px] md:w-[80px] h-[50px] md:h-[80px]  flex items-center
                 justify-center backdrop-blur-[1px] rounded-lg bg-gradient-to-r hover:scale-110
                  from-[#0a2532]/60 to-[#0a2532]/70 btn3"
              >
                ...
                >
                  <defs>
                    ...
                    >
                      <stop offset="0" stopColor="#6bfffc"></stop>
          ...
          <div className="w-full lg:w-1/2 relative hidden md:block ">
            <img
              src={image}
              alt="About Logo"
              className="mx-auto h-full scale-[1.15] translate-y-[52px]"
            />
          </div>
        </div>
      </div>
