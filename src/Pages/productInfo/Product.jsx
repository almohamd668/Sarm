  ...
  return (
    <section className="">
      <div className="container grid grid-cols-1 md:grid-cols-2 w-full mx-auto my-10 max-w-full md:min-w-[500px] min-h-[200px] rounded-lg ">
        ...
        <div className="con-card text-black text-sm border-0 w-full my-auto rounded-tr-lg rounded-br-lg p-5 h-fit min-h-[300px] max-w-full">
          <div className="address my-1 flex justify-between items-center">
            ...
            {/* <h3 className="text-sm md:text-lg text-white italic">Contain</h3> */}
          </div>
          <h4 className="my-1 text-2xl md:text-4xl font-bold text-white/95 italic">
            xcvxcvxcSD
          </h4>
          <p className="text-sm md:text-[18px] leading-10 text-white mt-4 ">
        ...
        <div className="con-bar h-[200px] grid grid-rows-5 items-end w-full gap-5">
          <div className="con-bro1 grid w-full grid-rows-2 gap-3">
            ...
            <div className="shadow-md shadow-secondary bg-slate-700 h-3 rounded-full flex text-trans1">
              <div className="bro-1 bg-gradient-to-r from-primary to-secondary w-[50%] h-full flex justify-center items-center text-white font-bold rounded-full text-xl">
                50%
              </div>
            </div>
          </div>
          ...
          <div className="con-bro1 grid w-full grid-rows-2">
            <h3 className="text-white indent-5">html</h3>
            <div className="shadow-md shadow-secondary bg-slate-700 h-3 rounded-full flex">
              <div className="bro-1 bg-gradient-to-r from-primary to-secondary w-[50%] h-full flex justify-center items-center text-white font-bold rounded-full text-xl">
                50%
