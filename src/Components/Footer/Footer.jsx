...
import qrImg from "../../assets/scan-qr.jpg";
const Footer = () => {
  return (
    <div className="bg-dBlack p-8 text-zinc-200 ">
      <div className="mx-auto md:container grid md:grid-cols-3 gap-5 gap-x-0 md:py-[50px]">
       

   
      <div className="flex justify-center  gap-5 items-center ">
      <img src={qrImg} alt="logo" height={150} width={160} className="rounded-lg" />
    </div>

    <div className="flex flex-wrap flex-col gap-y-3 items-center text-sm text-center my-3  md:text-lg ">
      
    <h5 className="text-lg font-bold md:text-3xl">Verify Your Product</h5>
    ...
    <div className="flex justify-center flex-col gap-5 items-center mb-4">
      <img src={image} alt="logo" height={300} width={300} />
      <div className="flex flex-wrap items-center gap-4">
        <a
          target="_blank"
          rel="noopener noreferrer"
          href="https://t.me/+905354669000"
        >
          ...
          <svg
            ...
            height="96"
            viewBox="0 0 96 96"
            className="w-[50px] !md:w-[30px] h-[50px] !md:h-[30px] hover:scale-105"
          >
            <path
              fill="#0fd2ff"
        ...
        <a
          target="_blank"
          rel="noopener noreferrer"
          href="https://www.instagram.com/titans_iraq_sport?igsh=MW51MzFucm40N3VzMQ=="
        >
